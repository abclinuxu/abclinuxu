...
public class DOM4JSize {
    ...
    // <about_myself>Zakladatel portálu AbcLinuxu.Linux používám od roku 1995, v roce 1999 jsem založil službu
    // Linux Hardware na Penguinovi, téhož roku jsem začal publikovat linuxové články převážně v ComputerWorldu,
    // LinuxWorldu a též na Rootovi. Roku 2002 jsem naprogramoval a založil tento portál a posléze s partnery i firmu
    // AbcLinuxu s.r.o., která zastřešuje provoz portálu a poskytuje řešení a služby založené na Linuxu.</about_myself>
