...
export JETTY_HOME=/data/abclinuxu_data/jetty-6.1.11
export JAVA_OPTIONS="-server -Xms100m -Xmx1500m"
export JAVA_OPTIONS="$JAVA_OPTIONS -Dorg.dom4j.QName.singleton.strategy=org.dom4j.util.PerThreadSingleton -Dorg.mortbay.jetty.Request.maxFormContentSize=5000000"
