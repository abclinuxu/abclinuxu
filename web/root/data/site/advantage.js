...
var AV_ERR_QUERY = 'AV_Chyba: snaha o znovu načtení reklamy AV_reload() bez předchozí inicializace AV_init(). ' + AV_ERR_CONCAT;
var AV_ERR_HTTP = 'AV_Chyba: nelze otevřít HTTP spojení pomocí funkce AV_reload(). ' + AV_ERR_CONCAT;
