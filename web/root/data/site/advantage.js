...
var AV_STOP = false; //umožòuje vypnutí reklamy
var AV_DEBUG = false;
var AV_CONTEXT_AD = true; //umožòuje vypnutí/zapnutí kontextové reklamy
...
function AV_toGET(variable, variableName){
	if (typeof(variable) == "object"){			
		...
		for(var i in variable){
			if (typeof(variable[i]) == 'function' || typeof(variable[i]) == 'object') continue; //nìkterý server pøedefinováva bázovou tøídu Array a pøídává jí vlastnost / metody
