...
<p>Zadejte odpovìdi na tuto otázku. Zkontrolujte pravopis otázky i odpovìdí.
Mù¾ete zadat a¾ pìt odpovìdí na tuto otázku. Po odeslání formuláøe se otázka
sma¾e a spolu s odpovìïmi se vyrenderuje pomocí ¹ablony /include/misc/talk_question.ftl
a vlo¾í na konec èlánku.</p>
