...
<p>
 ...
 <a href="http://www.abclinuxu.cz/software/EditItem?action=addRecord&relationId=${REL_ITEM.id}">pøidat</a>
 dal¹í záznam.
</p>
...
<#list RECORDS as REL_RECORD>
 ...
 <table cellspacing="0" border="1" cellpadding="5" width="100%">
  ...
  <tr>
    <td colspan="2">Tento záznam pøidal <a href="http://www.abclinuxu.cz/Profile?userId=${who.id}">${who.name}</a>
