...
Ve svém blogu můžete psát rady a návody, nebo pokroky vašeho
Open Source projektu, komentovat dění na linuxové scéně či
jako začátečník popisovat své pokroky s Linuxem. Nicméně blogy
jsou otevřené a pokud svými příspěvky nebudete porušovat zákony
či normy slušného chování, můžete psát na libovolné téma.
</p>

<p>Blogy na abclinuxu jsou službou jeho čtenářům. Pokud nejste
čtenář abclinuxu a s Linuxem nemáte nic společného, jen hledáte
...
<i>Linux</i>, <i>Škola</i>, <i>Básničky</i> či <i>GNU</i>.
</p>
