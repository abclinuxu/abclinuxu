...
<p>
    ...
    a Linuxu. Zadejte prosím jméno a co nejpodrobnější popis této osobnosti.
...
<form action="${URL.make("/edit")}" method="POST" name="persForm">
    <table cellpadding="0" border="0" width="100%">
        <tr>
            ...
            <td>
                <input tabindex="1" type="text" name="name" value="${PARAMS.name?if_exists}" size="30" maxlength="30">
        ...
        <tr>
            ...
            <td>
                <input tabindex="3" type="text" name="birthDate" value="${PARAMS.birthDate?if_exists}" size="30" maxlength="30">
        ...
        <tr>
            <td>Datum úmrtí</td>
            <td>
                <input tabindex="4" type="text" name="deathDate" value="${PARAMS.deathDate?if_exists}" size="30" maxlength="30">
        ...
        <tr>
            ...
            <td>
                <input tabindex="5" type="text" name="webUrl" value="${PARAMS.webUrl?if_exists}" size="40">
        ...
        <tr>
            <td>Adresa RSS</td>
            <td>
                <input tabindex="6" type="text" name="rssUrl" value="${PARAMS.rssUrl?if_exists}" size="40">
