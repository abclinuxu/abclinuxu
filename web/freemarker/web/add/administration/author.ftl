...
<p>Tento formulář slouží pro editaci autora.
    Foto by mělo mít rozměr přibližně 100x100 pixelů, pokud bude některý z rozměrů přesahovat tuto mez, obrázek bude
    automaticky zmenšen.
    Text o autorovi se zobrazí na jeho stránce. Neaktivní autor se nezobrazuje ve výběrech autorů, je to vhodné nastavit
