...
<p>
    Napi¹te jméno pojmu a jeho vysvìtlení. Pojem by mìl být buï linuxový nebo poèítaèový.
    Jméno pi¹te malými písmeny, velká písmena pou¾ijte jen pro ustálené zkratky (napøíklad SCSI).
    První znak jména pojmu musí být písmeno (a-z).
    Ze jména se vygeneruje URL adresa (po normalizacích - odstranìní v¹ech znakù kromì písmen, èísel,
    teèky a pomlèky, na konci i v¹ech teèek a pomlèek). Pokud se vám výsledné URL nelíbí, kontaktujte
    administrátory.
</p>
