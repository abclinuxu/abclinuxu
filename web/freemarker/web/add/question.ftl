...
<ul>
    ...
    <li>
        NEPI©TE VELKÝMI PÍSMENY nebo <b>tuènì</b> a nepou¾ívejte vykøièníky - je to nezdvoøilé.
    </li>
    <li>
...
<ul>
    ...
    <li>
        Popi¹te postup, který nevede k cíli. Uveïte, jestli jste postupovali podle nìjakého návodu.
...
<p>
    ...
    tazatel bude po¾ádán, aby jednotlivé problémy popsal v samostatných diskusích.
</p>
