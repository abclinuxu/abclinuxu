  ...
  <div id="zh-text" class="zh-box">
    ...
    <div id="zh-ad">
      <img class="zh-iko" src="/images/site2/sflista/64.gif">
        <b>Reklama:</b> <a href="http://www.64bit.cz/red-hat-enterprise-linux-4-es-predplatne-1-rok-basic/187/product.html">Red Hat Enterprise Linux 4 ES</a> - předplatné 1&nbsp;rok BASIC 8&nbsp;119,-&nbsp;Kč
    </div>
  </div>
