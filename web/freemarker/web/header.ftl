	...
	<div class="hl">
    	<div class="hl_vpravo">
            <#if USER?exists>
                ...
                <#if blogName!="UNDEF"><a href="/blog/${blogName}">Můj blog</a> |</#if>
        ...
        <div class="ls" id="ls"><div class="s">
            ...
            <#if VARS.currentPoll?exists>
                ...
                <div class="s_sekce">
                    ...
                    <input name="submit" type="submit" class="button" value="Hlasuj" src="/images/site2/vote_btn.gif" alt="Hlasuj"> &nbsp;Celkem ${total} hlasů<br>
            ...
            <div class="s_sekce">
                <ul>
                  ...
                  <li><a href="/kniha_navstev">Kniha návštěv</a></li>
