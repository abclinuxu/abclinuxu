  ...
  <div id="zh-text" class="zh-box">
    ...
    <div id="zh-ad">
      <img class="zh-iko" src="/images/site2/sflista/ah.gif">
        <b>AbcHost.cz:</b> Akce pro servery <a title="AbcHost.cz: HP ProLiant" href="http://www.abchost.cz/servery-hp-proliant-bl10e-blade/104/category.html">HP&nbsp;ProLiant</a>: u&nbsp;objednávek do&nbsp;31.12. dostanete první měsíc provozu zdarma!
    </div>
  </div>
