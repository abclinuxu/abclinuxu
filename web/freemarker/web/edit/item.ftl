...
<form action="${URL.make("/edit")}" method="POST">
 ...
 <table width="100%" border=0 cellpadding=5>
  ...
  <tr>
   ...
   <td>
    <input type="text" name="icon" value="${PARAMS.icon?if_exists}" size="40" tabindex="4" class="pole">
    <input type="submit" name="iconChooser" value="Vybìr ikon" class="buton">
   </td>
  </tr>
  <tr>
   <td width="120">&nbsp;</td>
   <td><input type="submit" VALUE="Dokonèi" TABINDEX="4" class="buton"></td>
  </tr>
 </table>
