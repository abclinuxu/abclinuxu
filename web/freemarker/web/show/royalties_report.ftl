...
<h2>Zobrazení souhrnu honorářů</h2>

<table style="font-size: small" cellspacing="0" border="1">
<#list RESULT as found>
        <tr>
           <td colspan="3" style="background:lightgray">
	      <b><a href="${found.author.url}">${TOOL.childName(found.author)}</a><code>&#09;&#09;${found.sum}</b>&#09;${TOOL.xpath(found.author.child, "/data/accountNumber")?default("bankovní účet není zadán")}</code>
	   </td>
