	...
	<tbody>
        <tr>
            <td style="text-align: left">
                <input type="text" name="filterAuthorsByName" value="${FILTER.value("filterAuthorsByName")}" title="Jméno" size="8"/>
                <input type="text" name="filterAuthorsBySurname" value="${FILTER.value("filterAuthorsBySurname")}" title="Příjmení" size="8"/>
            </td>
            <td style="text-align: left"><select name="filterAuthorsByContract">
            ...
            <td style="text-align: left"><select name="filterAuthorsByActive">
            ...
            <td style="text-align: left"><select name="filterAuthorsByArticles">
            ...
            <td style="text-align: left"><select name="filterAuthorsByRecent" title="Datum vydání posledního článku">
            ...
            <td style="text-align: left"><input type="submit" value="Filtruj" /></td>
        </tr>
