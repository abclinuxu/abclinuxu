...
public class EditAuthor implements AbcAction {
    ...
    public String actionAddStep1(HttpServletRequest request, HttpServletResponse response, Map env,
    ...
    public String actionAddStep2(HttpServletRequest request, HttpServletResponse response, Map env,
	PwdNavigator navigator) throws Exception {
    ...
    protected String actionEditStep1(HttpServletRequest request, Map env, PwdNavigator navigator)
	throws Exception {
	Map params = (Map) env.get(Constants.VAR_PARAMS);
    ...
    protected String actionEditStep2(HttpServletRequest request, HttpServletResponse response, Map env,
	PwdNavigator navigator) throws Exception {
    ...
    protected String actionRemoveStep1(HttpServletRequest request, Map env, PwdNavigator navigator)
	throws Exception {
    ...
    protected String actionRemoveStep2(HttpServletRequest request, HttpServletResponse response, Map env,
	PwdNavigator navigator) throws Exception {
	...
	urlUtils.redirect(
	    response, urlUtils.make(UrlUtils.PREFIX_ADMINISTRATION + "/redakce/autori/show?aId="
		+ author.getId()
		+ "&action=show"));
    }
