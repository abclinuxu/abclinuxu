...
public class ShowAuthor implements AbcAction {
	...
	PwdNavigator navigator = new PwdNavigator(user, PwdNavigator.NavigationType.ADMIN_AUTHORS);
	...
	// create filters
	FormFilter filter = new FormFilter(params, FormFilter.AUTHORS_BY_NAME, FormFilter.AUTHORS_BY_SURNAME, FormFilter.AUTHORS_BY_CONTRACT, FormFilter.AUTHORS_BY_ACTIVE, FormFilter.AUTHORS_BY_ARTICLES, FormFilter.AUTHORS_BY_RECENT);
