...
public class MySqlPersistence implements Persistence {
    ...
    public void create(GenericObject obj) {
        ...
        try {
            ...
            if ( obj instanceof Poll ) {
                ...
                if ( result==0 )
                    throw new PersistenceException("Nepodaøilo se vlo¾it "+obj+" do databáze!");
            ...
            if ( e.getErrorCode()==1062 ) {
                ...
                throw new PersistenceException("Nemohu ulo¾it "+obj,e);
            }
        } finally {
    ...
    private void storeComment(RowComment comment, PreparedStatement statement) throws SQLException {
        if (comment.getRowId()==0) {
            ...
            int result = statement.executeUpdate();
            if (result == 0)
                throw new PersistenceException("Nepodaøilo se vlo¾it " + comment + " do databáze!");
    ...
    public List findByCommand(String command) {
        ...
        try {
            ...
            throw new PersistenceException("Chyba pøi hledání podle "+command+"!",e);
        } finally {
            releaseSQLResources(con,statement,resultSet);
        }
        return result;
...
//                Sorters2.byId(records);
    ...
    public Map getCountersValue(List objects, String  type) {
        ...
        try {
            ...
            throw new PersistenceException("Selhalo hledání èítaèù!");
        } finally {
            releaseSQLResources(con, statement, resultSet);
        }
    }
    ...
    public Map<GenericObject, List<Relation>> findChildren(List objects) {
        ...
        try {
            ...
            throw new PersistenceException("Selhalo hledání potomkù!");
        } finally {
            releaseSQLResources(con,statement,resultSet);
        }
    }
    ...
    protected void storePoll(Poll poll) throws SQLException {
        ...
        try {
            ...
            int result = statement.executeUpdate();
            if ( result==0 ) {
                throw new PersistenceException("Nepodaøilo se vlo¾it anketu do databáze!");
            }
    ...
    public void update(GenericDataObject obj) {
        ...
        try {
            ...
            int result = statement.executeUpdate();
            if ( result!=1 )
                throw new PersistenceException("Nepodaøilo se ulo¾it zmìny v "+obj.toString()+" do databáze!");
            ...
            throw new PersistenceException("Nemohu ulo¾it zmìny do databáze!",e);
        } finally {
            releaseSQLResources(con,statement,resultSet);
        }
    }
    ...
    public void update(Relation relation) {
        ...
        try {
            ...
            int result = statement.executeUpdate();
            if ( result!=1 ) {
                throw new PersistenceException("Nepodaøilo se ulo¾it zmìny v "+relation.toString()+" do databáze!");
            }
    ...
    public void update(Link link) {
        ...
        try {
            ...
            int result = statement.executeUpdate();
            if ( result!=1 ) {
                throw new PersistenceException("Nepodarilo se ulo¾it zmìny v "+link.toString()+" do databáze!");
            }

            link.setUpdated(new java.util.Date());
            cache.store(link);
        } catch (SQLException e) {
            throw new PersistenceException("Nemohu ulo¾it zmìny v "+link.toString()+" do databáze!",e);
        } finally {
            releaseSQLResources(con,statement,resultSet);
        }
    }
    ...
    public void update(Poll poll) {
        ...
        try {
            ...
            int result = statement.executeUpdate();
            if ( result!=1 )
                throw new PersistenceException("Nepodarilo se ulo¾it zmìny v "+poll.toString()+" do databáze!");

            cache.store(poll);
        } catch (SQLException e) {
            throw new PersistenceException("Nemohu ulo¾it zmìny v "+poll.toString()+" do databáze!",e);
        } finally {
            releaseSQLResources(con,statement,resultSet);
        }
    }
    ...
    public void update(User user) {
        ...
        try {
            ...
            int result = statement.executeUpdate();
            if ( result!=1 ) {
                throw new PersistenceException("Nepodarilo se ulo¾it zmìny v "+user.toString()+" do databáze!");
            }
