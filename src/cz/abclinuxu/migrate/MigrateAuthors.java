...
public class MigrateAuthors {
    ...
    private static final int AUTHORS_PERMISSIONS = Permissions.computePermissions(new Permissions(Permissions.PERMISSION_MODIFY),
            new Permissions(Permissions.PERMISSION_CREATE | Permissions.PERMISSION_DELETE | Permissions.PERMISSION_MODIFY),
    ...
    private void safeAppendElement(Element root, String xpath, String value) throws InvalidDataException {
        ...
        // there is node, what to do if its value differs from one to be set
            ...
            throw new InvalidDataException("Author already contains node of " + root.getPath() + "/" + xpath + ", with value: " + tmp.getText() + ", which differs from: " + value);
        }
    }
    ...
    private String authorToString(Item author) {
        ...
        sb.append("Author:").append(" id:").append(author.getId()).append(" first name:").append(author.getString1()).append(" last name:").append(author.getString2()).append(" uid:").append(author.getNumeric1()).append(" activity:").append(author.getNumeric2()).append("\n");
