...
/**
 * Decorator for Dictionary items.
 */
public class DictionaryDecorator implements Decorator, Configurable {
    ...
    public Map getEnvironment(MonitorAction action) {
        ...
        env.put(EmailSender.KEY_TEMPLATE, "/mail/monitor/notif_dictionary.ftl");
