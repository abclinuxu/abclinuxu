...
/**
 * Decorator for Hardware items.
 */
public class HardwareDecorator implements Decorator, Configurable {
    ...
    public Map getEnvironment(MonitorAction action) {
        ...
        env.put(EmailSender.KEY_TEMPLATE, "/mail/monitor/notif_hardware.ftl");
