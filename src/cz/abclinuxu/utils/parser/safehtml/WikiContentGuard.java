...
public class WikiContentGuard {
    ...
    static {
//        TAGS.put("FORM", new CheckedTag("FORM", true, new String[]{"ACTION", "METHOD"})); // proc?!
        TAGS.put("IMG", new CheckedTag("IMG", false, new String[]{"SRC", "WIDTH", "HEIGHT", "BORDER", "ALT", "STYLE"}));
        TAGS.put("INPUT", new CheckedTag("INPUT", false, new String[]{"TYPE", "NAME", "VALUE", "ID", "SIZE", "TABINDEX"})); // k cemu se to pouziva?
        TAGS.put("LABEL", new CheckedTag("LABEL", true, new String[]{"FOR"})); // k cemu se to pouziva?
        TAGS.put("OPTION", new CheckedTag("OPTION", true, new String[]{"VALUE"})); // k cemu se to pouziva?
        TAGS.put("P", new CheckedTag("P", false, new String[]{"ID", "CLASS", "STYLE"}));
        TAGS.put("SELECT", new CheckedTag("SELECT", true, new String[]{"NAME", "ID"})); // k cemu se to pouziva?
    }
